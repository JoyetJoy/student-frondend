...
const Navbar = ({ setUsers }) => {
  ...
  return (
    <div className="w-full h-20 flex flex-row items-center bg-[#173f59]">
      <div className="w-80 h-full flex items-center justify-center text-white font-semibold text-xl ">STUDENTS</div>
      ...
      <div className="h-full w-2/6 flex items-center justify-end gap-[10%] pr-10">
        ...
        <div className="text-xl text-white"><Link to={`/user/account/${id}`}>Account</Link></div>
